                          ...
                          <Fragment>
                            <Grid>
                              <Grid item style={styles.CardContentSegments}>
                                <Typography style={styles.EmptyCartHeading}>
                                  OOPS! NOTHING FOUND!
                                </Typography>
                              </Grid>
                            </Grid>
                            ...
                            <Grid>
                              <Grid item style={styles.CardContentSegments}>
                                <img
                                  ...
                                  src={require("../content/img/empty-cart.png")}
                                  alt="sadad"
                                />
                              </Grid>
                            </Grid>
                            <Typography style={styles.CartSubHeading}>
                              No records found. Please do some transactions to
                              see history.
                            </Typography>
                            <Fab
                              variant="extended"
                    ...
                    <Paper>
                      <Grid container>
                        ...
                        <Grid Item item xs={2} sm={2} md={2} lg={2}>
                          <Typography style={styles.CardAmount}>
                            BHD {e.Amount}
                          </Typography>
