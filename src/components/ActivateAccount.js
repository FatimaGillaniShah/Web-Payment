                                ...
                                <div class="login-wrap">
                                    ...
                                    <div class="content-area">
                                        ...
                                        <form >                               
                                            ...
                                            <div class="form-group">
                                                <fieldset>
                                                    <input autocomplete="off" class="form-control1" data-val="true" data-val-required="Enter Your Password" id="password" name="password" placeholder="Activation Code" type="text" /><i class="password"></i>
                                                </fieldset>
                                            </div>
                                            ...
                                            <button className="green-btn btn-block btn-lg" type="submit">ACTIVATE</button>
